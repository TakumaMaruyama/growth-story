...
export default function Home() {
    ...
    useEffect(() => {
        const loadHome = async () => {
            try {
                ...
                if (json.competitionGoals) {
                    json.competitionGoals = json.competitionGoals.map((g: any) => ({
                        ...g,
                        targetDate: g.targetDate ? new Date(g.targetDate) : null,
                        updatedAt: g.updatedAt ? new Date(g.updatedAt) : null,
                    }));
                }
                if (json.latestStory && json.latestStory.createdAt) {
                    json.latestStory.createdAt = new Date(json.latestStory.createdAt);
                }
    ...
    const { user, todayLog, latestStory, dailyLogCount, storyVersionCount, competitionGoals } = data;
    const today = todayJST();
    
    const sortedCompetitionGoals = sortCompetitionGoalsForDisplay((competitionGoals || []) as any[], today);
            ...
            <main id="main-content" className="container">
                ...
                <section className="summary-grid" aria-label="記録のサマリー">
                    <div className="summary-item">
                        ...
                        <p className="summary-value">{dailyLogCount || 0}<span className="visually-hidden">日</span></p>
                    </div>
                    <div className="summary-item">
                    ...
                    <div className="summary-item">
                        ...
                        <p className="summary-value">{storyVersionCount || 0}<span className="visually-hidden">回</span></p>
                    </div>
                </section>
                ...
                <section className="card" aria-labelledby="goals-heading">
                    ...
                    {(competitionGoals || []).length > 0 ? (
                        <div className="goals-milestone-list">
                            {displayedCompetitionGoals.map((goal: any) => {
                                ...
                                return (
                                    <article key={goal.id} className="summary-item">
                                        <div className="goal-list-badges">
                                            <span className="badge badge-secondary">{GOAL_TYPE_LABELS[goal.type as keyof typeof GOAL_TYPE_LABELS]}</span>
