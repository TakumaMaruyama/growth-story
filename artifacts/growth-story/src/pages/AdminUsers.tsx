...
export default function AdminUsersPage() {
    ...
    const fetchUsers = useCallback(async (cursor?: string, append = false) => {
        ...
        try {
            ...
            const response = await fetch(`/api/admin/users${query}`, { credentials: 'include', cache: 'no-store' });
    ...
    const fetchRegistrationLink = useCallback(async () => {
        ...
        try {
            const response = await fetch('/api/admin/registration-link', { credentials: 'include', cache: 'no-store' });
    ...
    const issuePasswordResetLink = async (target: UserListItem) => {
        ...
        try {
            const response = await fetch(`/api/admin/users/${target.id}/password-reset`, { credentials: 'include',
                method: 'POST',
