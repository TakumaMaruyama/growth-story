export const STORY_QUESTIONS = [
    ...
    { no: 4, label: '競泳で悔しかったことと、そこから学んだことは？' },
    { no: 5, label: '好きな、または得意な泳法・種目は？その理由は？' },
    { no: 6, label: '尊敬する選手は？その理由は？' },
    { no: 7, label: 'チームで好きな時間や、仲間・コーチから学んだことは？' },
    { no: 8, label: '練習で大切にしていることは？' },
    { no: 9, label: '試合前のルーティンは？' },
    { no: 10, label: '今一番頑張っていることは？' },
    { no: 11, label: '1年後の目標は？' },
    { no: 12, label: '3年後の目標は？' },
    { no: 13, label: 'いつか競泳を終えるとき、どんな「ラストシーン」を迎えたい？' },
    { no: 14, label: '競泳以外で好きなこと・得意なことは？' },
    { no: 15, label: '自分を応援してくれている人へ、伝えたいことは？' },
] as const;
